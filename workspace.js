...
cprequire_test(["inline:com-chilipeppr-workspace-simple-g2"], function(ws) {
    ...
    $('title').html("simple-g2 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-simple-g2", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-simple-g2", // Make the id the same as the cpdefine id
        name: "Workspace / simple-g2", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace simple-g2.`,
        ...
        /**
         * Load the Template widget via chilipeppr.load() so folks have a simple-g2
