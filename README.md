# com-chilipeppr-workspace-simple-g2
A ChiliPeppr Workspace simple-g2.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / simple-g2
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-simple-g2 |
| Name                  | Workspace / simple-g2 |
| Description           | A ChiliPeppr Workspace simple-g2. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/vanwiththeplan/workspace-Simple-G2/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/vanwiththeplan/workspace-simple-g2 |
| Github URL            | http://github.com/vanwiththeplan/workspace-Simple-G2 |
| Test URL              | https://preview.c9users.io/vanwiththeplan/workspace-simple-g2/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/vanwiththeplan/workspace-Simple-G2/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-simple-g2"], // the id you gave your workspace
      function(myWorkspaceSimpleG2) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / simple-g2 just got loaded.", myWorkspaceSimpleG2);
        myWorkspaceSimpleG2.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-simple-g2"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / simple-g2"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace simple-g2."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/vanwiththeplan/workspace-Simple-G2/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/vanwiththeplan/workspace-simple-g2"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/vanwiththeplan/workspace-Simple-G2"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-simple-g2-vanwiththeplan.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
